...
\section{Estadística Descriptiva}
    ...
    a la simetría, contienen datos atípicos en proteínas y grasas en una región 
    ...
    apreciar como justamente existen un alta concentración de recetas en una intervalo pequeño 
    ...
    \begin{center}
        \includegraphics[width=0.75\textwidth]{2_01_plot_01}
    \end{center}
