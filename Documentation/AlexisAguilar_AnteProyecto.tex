...
\section{Muestreo e Intervalos de Confianza}
    ...
    \subsection{Hipótesis}
        De las medias muestrales (aleatoria y estratificada) de la 
        proporción de carbohidratos, ¿Existe una diferencia significativa 
        entre ellas o se pueden considerar que son la misma media?
